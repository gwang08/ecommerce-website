        ...
        <main>
            ...
            <div class="advertisement-slider">
                <div class="ad-container">
                    <div class="ad-item">
                        <a href="#">
                            <img src="images/637565119128257674_giasoccuoituan-thumb.jpg" alt="Quảng cáo 1"/>
                        </a>
                    </div>
                    <div class="ad-item">
                        <a href="#">
                            <img src="images/637430480951007729_12-12-sieusale-fptshop-thumb.jpg" alt="Quảng cáo 2"/>
                        </a>
                    </div>
                    <div class="ad-item">
                        <a href="#">
                            <img src="images/637508955679571961_tuanleapple-thumb.jpg" alt="Quảng cáo 2"/>
                        </a>
                    </div>
                    <div class="ad-item">
                        <a href="#">
                            <img src="images/637713231126787694_nf_1200x628-3.jpg" alt="Quảng cáo 2"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="product-section">
                ...
                <div class="product-container-wrapper">
                    <button class="scroll-button left" onclick="document.getElementById('phone-container').scrollBy({left: -300, behavior: 'smooth'})">&lt;</button>
                    <div id="phone-container" class="product-container">
                        <c:forEach var="product" items="${phoneProducts}">
                        ...
                        <c:if test="${empty phoneProducts}">
                            <p>No phones available.</p>
                        </c:if>
                    </div>
                    <button class="scroll-button right" onclick="document.getElementById('phone-container').scrollBy({left: 300, behavior: 'smooth'})">&gt;</button>
                </div>
            </div>
            ...
            <div class="product-section">
                <h3>Máy tính</h3>
                <div class="product-container-wrapper">
                    <button class="scroll-button left" onclick="document.getElementById('computer-container').scrollBy({left: -300, behavior: 'smooth'})">&lt;</button>
                    <div id="computer-container" class="product-container">
                        <c:forEach var="product" items="${computerProducts}">
                            <div class="product-item">
                                <a href="ProductDetailController?productID=${product.productID}">
                                    <img src="${product.imageURL}" alt="${product.name}" class="product-image"/>
                                    <h4>${product.name}</h4>
                        ...
                        <c:if test="${empty computerProducts}">
                            <p>No computers available.</p>
                        </c:if>
                    </div>
                    <button class="scroll-button right" onclick="document.getElementById('computer-container').scrollBy({left: 300, behavior: 'smooth'})">&gt;</button>
                </div>
            </div>
            ...
            <div class="product-section">
                ...
                <div class="product-container-wrapper">
                    <button class="scroll-button left" onclick="document.getElementById('electronic-container').scrollBy({left: -300, behavior: 'smooth'})">&lt;</button>
                    <div id="electronic-container" class="product-container">
                        <c:forEach var="product" items="${electronicProducts}">
                            <div class="product-item">
                                <a href="ProductDetailController?productID=${product.productID}">
                                    <img src="${product.imageURL}" alt="${product.name}" class="product-image"/>
                                    <h4>${product.name}</h4>
                        ...
                        <c:if test="${empty electronicProducts}">
                            <p>No electronics available.</p>
                        </c:if>
                    </div>
                    <button class="scroll-button right" onclick="document.getElementById('electronic-container').scrollBy({left: 300, behavior: 'smooth'})">&gt;</button>
                </div>
            </div>
        </main>
